import{x as g}from"./lit-element-D5YJkDF8.js";import{T as m,a as p}from"./tree-data-D6XDig43.js";import"./iframe-GQn2qLnj.js";const $={title:"Components/CosmozTreenodeNavigator/Legacy",component:"cosmoz-treenode-navigator",tags:["autodocs"],argTypes:{searchPlaceholder:{control:"text"},searchGlobalPlaceholder:{control:"text"},searchMinLength:{control:"number"},searchDebounceTimeout:{control:"number"},opened:{control:"boolean"},nodePath:{control:"text"}}},h=e=>{const a=new m(p),i=e.nodePath?a.getNodeByPathLocator(e.nodePath):void 0;return g`
        <div
