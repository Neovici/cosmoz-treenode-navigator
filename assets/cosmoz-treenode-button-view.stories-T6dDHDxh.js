import{x as b}from"./lit-element-D-o1_RG-.js";import{T as p,a as T}from"./tree-data-BDB9dPvE.js";import"./cosmoz-treenode-button-view-DSBZyU7q.js";import"./iframe-BCVyvl2y.js";const v={title:"Components/CosmozTreenodeButtonView",component:"cosmoz-treenode-button-view",tags:["autodocs"],argTypes:{buttonTextPlaceholder:{control:"text"},dialogText:{control:"text"},searchPlaceholder:{control:"text"},searchGlobalPlaceholder:{control:"text"},searchMinLength:{control:"number"},searchDebounceTimeout:{control:"number"},noReset:{control:"boolean"},multiSelection:{control:"boolean"}}},a=e=>{const m=new p(T);return b`
