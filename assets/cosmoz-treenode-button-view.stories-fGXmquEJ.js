import{x as s}from"./iframe-LZF2Cg0q.js";import{T as c,a as i}from"./tree-data-DFN870TQ.js";import"./cosmoz-treenode-button-view-Cwm7f_HP.js";import"./preload-helper-PPVm8Dsz.js";const b={title:"Components/CosmozTreenodeButtonView",component:"cosmoz-treenode-button-view",tags:["autodocs"],argTypes:{buttonTextPlaceholder:{control:"text"},dialogText:{control:"text"},searchPlaceholder:{control:"text"},searchGlobalPlaceholder:{control:"text"},searchMinLength:{control:"number"},searchDebounceTimeout:{control:"number"},noReset:{control:"boolean"},multiSelection:{control:"boolean"}}},l=e=>{const r=new c(i);return s`
