import{x as L}from"./lit-element-D-o1_RG-.js";import{T as D,a as N,n as R}from"./tree-data-BDB9dPvE.js";import"./cosmoz-treenode-button-view-DSBZyU7q.js";import"./iframe-BCVyvl2y.js";const W={title:"Components/CosmozTreenodeButtonView/Legacy",component:"cosmoz-treenode-button-view",tags:["autodocs"],argTypes:{buttonTextPlaceholder:{control:"text"},dialogText:{control:"text"},searchPlaceholder:{control:"text"},searchGlobalPlaceholder:{control:"text"},searchMinLength:{control:"number"},searchDebounceTimeout:{control:"number"},noReset:{control:"boolean"},multiSelection:{control:"boolean"},nodePath:{control:"text"}}},d=e=>{const s=new D(N),n=e.nodePath?s.getNodeByPathLocator(e.nodePath):void 0;return L`
