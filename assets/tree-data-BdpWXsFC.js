 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const F=(s,t)=>{const e=s._$AN;if(e===void 0)return!1;for(const i of e)i._$AO?.(t,!1),F(i,t);return!0},Z=s=>{let t,e;do{if((t=s._$AM)===void 0)break;e=t._$AN,e.delete(s),s=t}while(e?.size===0)},Dt=s=>{for(let t;t=s._$AM;s=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(s))break;e.add(s),be(t)}};function ge(s){this._$AN!==void 0?(Z(this),this._$AM=s,Dt(this)):this._$AM=s}function ve(s,t=!1,e=0){const i=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(t)if(Array.isArray(i))for(let n=e;n<i.length;n++)F(i[n],!1),Z(i[n]);else i!=null&&(F(i,!1),Z(i));else F(this,s)}const be=s=>{s.type==z.CHILD&&(s._$AP??=ve,s._$AQ??=ge)};class Vt extends X{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,i){super._$AT(t,e,i),Dt(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(F(this,t),Z(this))}setValue(t){if(At(this._$Ct))this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}const{component:_t}=me({render:Jt}),ct=new WeakMap,mt=j(class extends Vt{render(s){return H}update(s,[t]){const e=t!==this.G;return e&&this.G!==void 0&&this.rt(void 0),(e||this.lt!==this.ct)&&(this.G=t,this.ht=s.options?.host,this.rt(this.ct=s.element)),H}rt(s){if(this.isConnected||(s=void 0),typeof this.G=="function"){const t=this.ht??globalThis;let e=ct.get(t);e===void 0&&(e=new WeakMap,ct.set(t,e)),e.get(this.G)!==void 0&&this.G.call(this.ht,void 0),e.set(this.G,s),s!==void 0&&this.G.call(this.ht,s)}else this.G.value=s}get lt(){return typeof this.G=="function"?ct.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});/**
 * @license
...
`,Ve=["type","pattern","allowed-pattern","min","max","step","autosize","label",...Ut],Be=s=>{const{type:t="text",pattern:e,allowedPattern:i,autocomplete:r,value:n,readonly:o,disabled:l,min:c,max:a,step:v,maxlength:u}=s,{onChange:p,onFocus:f,onInput:g,onRef:_}=Ht(s),d=Me(i);return Ft({focus:()=>s.shadowRoot?.querySelector("#input")?.focus()},[]),jt(E`
			<input
				${mt(_)}
...
`,Ke=({tree:s,searchPlaceholder:t,searchGlobalPlaceholder:e,searchMinLength:i=3,opened:r,searchDebounceTimeout:n=2e3})=>{const o=It(),l=Re(),[c,a]=q("highlightedNode"),[v,u]=q("nodesOnNodePath",[]),[p,f]=ht(""),[g,_]=ht(""),[d,m]=ht(""),[y,C]=q("selectedNode"),[it,Gt]=q("nodePath","");S(()=>{const h=setTimeout(()=>{const b=g.trim().length;b>0&&b<i||f(g.trim())},n);return()=>clearTimeout(h)},[g]);const rt=R(()=>qe(s,p,d),[s,p,d]),gt=x(h=>{if(!h?.pathLocator||!s){u([]);return}const b=kt(h.pathLocator,s);u(b)},[s]),U=x(h=>{m(h?.pathLocator||""),_(""),a(null)},[]),nt=x(h=>{h&&(a(h),C(h),Gt(h.pathLocator??""),gt(h))},[gt]);S(()=>{if(!v?.length||!s||!r)return;const h=v[v.length-1];if(!h?.pathLocator)return;if(s.hasChildren(h)){m(h.pathLocator);return}const b=ut(s,h);m(b),a(h)},[v,s,r]),S(()=>{pt(l,"highlightedNodePath",c?.pathLocator||"")},[c]),S(()=>{y&&y!==c&&a(y)},[y]),S(()=>{if(!(it||s))return;const h=kt(it,s);u(h);const b=h.length>0?h[h.length-1]:null;b&&b!==c&&a(b)},[it,s]);const I=We({dataPlane:rt,highlightedNode:c??null,onNodeClick:U});S(()=>{if(!r)return;const h=()=>{const w=o.current;return w?w[Object.getOwnPropertySymbols(w)[0]]:null},b=h();if(b&&I.highlightedNode){const w=I.dataPlane?.indexOf(I.highlightedNode);w!==void 0&&w>=0&&(b.scrollToIndex={index:w,position:"center"})}const D=w=>{if(w.ctrlKey&&w.altKey||w.defaultPrevented)return;const{dataPlane:W,highlightedNode:O,onNodeClick:Qt}=I,G=h();if(!G)return;const ot=W.findIndex(P=>P.pathLocator===O?.pathLocator),vt=(P,bt)=>P>=0&&P<W.length?(a(W[P]),(bt==="start"?P<G._firstVisible:P>G._lastVisible)&&(G.scrollToIndex={index:P,position:bt}),!0):!1;switch(w.key){case"Up":case"ArrowUp":{w.preventDefault(),vt(Math.max(ot-1,0),"start");break}case"Down":case"ArrowDown":{w.preventDefault(),ot<W.length-1&&vt(ot+1,"end");break}case"Enter":w.preventDefault(),O&&(l.dispatchEvent(new CustomEvent("node-dblclicked")),nt(O));break;case"Right":case"ArrowRight":w.preventDefault(),O&&s.hasChildren(O)&&Qt(O);break}};return document.addEventListener("keydown",D,!0),()=>document.removeEventListener("keydown",D,!0)},[r,I,nt]);const qt=h=>b=>{Qe(b,l),nt(h)},Yt=(h,b)=>h?E` <div class="item">
