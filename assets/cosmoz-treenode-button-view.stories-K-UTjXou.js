import{x as b}from"./lit-element-D5YJkDF8.js";import{T as p,a as T}from"./tree-data-CXI3kqpg.js";import"./cosmoz-treenode-button-view-BDvOo5in.js";import"./iframe-D9sFQmMn.js";const v={title:"Components/CosmozTreenodeButtonView",component:"cosmoz-treenode-button-view",tags:["autodocs"],argTypes:{buttonTextPlaceholder:{control:"text"},dialogText:{control:"text"},searchPlaceholder:{control:"text"},searchGlobalPlaceholder:{control:"text"},searchMinLength:{control:"number"},searchDebounceTimeout:{control:"number"},noReset:{control:"boolean"},multiSelection:{control:"boolean"}}},a=e=>{const m=new p(T);return b`
