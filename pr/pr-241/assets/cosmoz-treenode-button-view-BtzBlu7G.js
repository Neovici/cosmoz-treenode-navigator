import{c as E,o as F,n as z,b as N,d as K,s as _,u as P,e as w,f as B,g as U,h as O,i as H,j as I,k as tt,l as et}from"./tree-data-DD2NUZ4m.js";import{w as ot,b as m,e as nt,A as rt,t as M}from"./iframe-aKhzd7F8.js";const st=E`
	overflow: hidden;
...
`),X=(t,r,o)=>nt(m`<cosmoz-tooltip-content>
		...
		</cosmoz-tooltip-content>`,t),lt=(t,r)=>{const{for:o,heading:s,description:h,placement:c="top",delay:d=300,disabled:a=!1}=r,i=P();w(()=>{if(!o)return;const n=t.getRootNode(),f=n.adoptedStyleSheets??[];f.includes(C)||(n.adoptedStyleSheets=[...f,C]);const e=document.createElement("div");e.setAttribute("popover","manual"),e.setAttribute("role","tooltip"),e.classList.add("cosmoz-tooltip-popover"),t.after(e),i.current=e,X(e,s,h);const v=`[name="${o}"]`,y=`--tooltip-anchor-${o}`;let b;const x=l=>{a||(clearTimeout(b),l.style.anchorName=y,e.style.positionAnchor=y,e.style.positionArea=c,b=window.setTimeout(()=>e.showPopover(),d))},k=()=>{clearTimeout(b),e.hidePopover()},L=l=>{const p=l.target.closest?.(v);p&&x(p)},T=l=>{const p=l.target.closest?.(v);if(!p)return;const S=l.relatedTarget;S&&p.contains(S)||k()},$=l=>{const p=l.target.closest?.(v);p&&x(p)},A=l=>{l.target.closest?.(v)&&k()};return n.addEventListener("pointerover",L),n.addEventListener("pointerout",T),n.addEventListener("focusin",$),n.addEventListener("focusout",A),()=>{clearTimeout(b),n.removeEventListener("pointerover",L),n.removeEventListener("pointerout",T),n.removeEventListener("focusin",$),n.removeEventListener("focusout",A),e.hidePopover(),e.remove(),i.current=void 0}},[o,c,d,a]),w(()=>{!o||!i.current||X(i.current,s,h)},[s,h,o]),w(()=>{!a||!i.current||i.current.hidePopover()},[a])},dt=E`
	:host {
