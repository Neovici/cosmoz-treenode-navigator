import{x as i}from"./iframe-7xIRZ22c.js";import{T as g,a as u,n as m}from"./tree-data-CsIRB82D.js";import"./cosmoz-treenode-button-view-CcQIp-2G.js";import"./preload-helper-PPVm8Dsz.js";const x={title:"Components/CosmozTreenodeButtonView/Legacy",component:"cosmoz-treenode-button-view",tags:["autodocs"],argTypes:{buttonTextPlaceholder:{control:"text"},dialogText:{control:"text"},searchPlaceholder:{control:"text"},searchGlobalPlaceholder:{control:"text"},searchMinLength:{control:"number"},searchDebounceTimeout:{control:"number"},noReset:{control:"boolean"},multiSelection:{control:"boolean"},nodePath:{control:"text"}}},d=e=>{const s=new g(u),n=e.nodePath?s.getNodeByPathLocator(e.nodePath):void 0;return i`
