import{x as i}from"./iframe--KMTR7Nr.js";import{T as g,a as u,n as m}from"./tree-data-B0JpGB_T.js";import"./cosmoz-treenode-button-view-BI0VTpEE.js";import"./preload-helper-PPVm8Dsz.js";const x={title:"Components/CosmozTreenodeButtonView/Legacy",component:"cosmoz-treenode-button-view",tags:["autodocs"],argTypes:{buttonTextPlaceholder:{control:"text"},dialogText:{control:"text"},searchPlaceholder:{control:"text"},searchGlobalPlaceholder:{control:"text"},searchMinLength:{control:"number"},searchDebounceTimeout:{control:"number"},noReset:{control:"boolean"},multiSelection:{control:"boolean"},nodePath:{control:"text"}}},d=e=>{const s=new g(u),n=e.nodePath?s.getNodeByPathLocator(e.nodePath):void 0;return i`
