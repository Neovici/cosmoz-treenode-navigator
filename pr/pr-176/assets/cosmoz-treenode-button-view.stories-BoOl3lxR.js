import{x as s}from"./iframe--KMTR7Nr.js";import{T as c,a as i}from"./tree-data-B0JpGB_T.js";import"./cosmoz-treenode-button-view-BI0VTpEE.js";import"./preload-helper-PPVm8Dsz.js";const b={title:"Components/CosmozTreenodeButtonView",component:"cosmoz-treenode-button-view",tags:["autodocs"],argTypes:{buttonTextPlaceholder:{control:"text"},dialogText:{control:"text"},searchPlaceholder:{control:"text"},searchGlobalPlaceholder:{control:"text"},searchMinLength:{control:"number"},searchDebounceTimeout:{control:"number"},noReset:{control:"boolean"},multiSelection:{control:"boolean"}}},l=e=>{const r=new c(i);return s`
