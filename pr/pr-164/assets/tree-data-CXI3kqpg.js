 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pe={},$e=W(class extends st{constructor(){super(...arguments),this.ot=Pe}render(s,t){return t()}update(s,[t,e]){if(Array.isArray(t)){if(Array.isArray(this.ot)&&this.ot.length===t.length&&t.every((i,r)=>i===this.ot[r]))return A}else if(this.ot===t)return A;return this.ot=Array.isArray(t)?Array.from(t):t,this.render(t,e)}});/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pt=(s,t,e)=>{const i=new Map;for(let r=t;r<=e;r++)i.set(s[r],r);return i},ke=W(class extends st{constructor(s){if(super(s),s.type!==z.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,t,e){let i;e===void 0?e=t:t!==void 0&&(i=t);const r=[],n=[];let o=0;for(const h of s)r[o]=i?i(h,o):o,n[o]=e(h,o),o++;return{values:n,keys:r}}render(s,t,e){return this.dt(s,t,e).values}update(s,[t,e,i]){const r=ne(s),{values:n,keys:o}=this.dt(t,e,i);if(!Array.isArray(r))return this.ut=o,n;const h=this.ut??(this.ut=[]),l=[];let a,v,d=0,f=r.length-1,_=0,b=n.length-1;for(;d<=f&&_<=b;)if(r[d]===null)d++;else if(r[f]===null)f--;else if(h[d]===o[_])l[_]=N(r[d],n[_]),d++,_++;else if(h[f]===o[b])l[b]=N(r[f],n[b]),f--,b--;else if(h[d]===o[b])l[b]=N(r[d],n[b]),F(s,l[b+1],r[d]),d++,b--;else if(h[f]===o[_])l[_]=N(r[f],n[_]),F(s,r[d],r[f]),f--,_++;else if(a===void 0&&(a=Pt(o,_,b),v=Pt(h,d,f)),a.has(h[d]))if(a.has(h[f])){const g=v.get(o[_]),m=g!==void 0?r[g]:null;if(m===null){const p=F(s,r[d]);N(p,n[_]),l[_]=p}else l[_]=N(m,n[_]),F(s,r[d],m),r[g]=null;_++}else ct(r[f]),f--;else ct(r[d]),d++;for(;_<=b;){const g=F(s,l[b+1]);N(g,n[_]),l[_++]=g}for(;d<=f;){const g=r[d++];g!==null&&ct(g)}return this.ut=o,Vt(s,l),A}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const P=s=>s??U,Yt=R(class extends T{constructor(t,e,i,r){super(t,e);u(this,"values");Object.assign(e.host,i),this.values=r}update(t,e){this.hasChanged(e)&&(this.values=e,Object.assign(this.state.host,t))}hasChanged(t=[]){return t.some((e,i)=>this.values[i]!==e)}}),He=R(class extends T{update(){return this.state.host}}),je=/([A-Z])/gu,et=(s,t,e)=>{s[t]=e,s.dispatchEvent(new CustomEvent(t.replace(je,"-$1").toLowerCase()+"-changed",{detail:{value:e}}))},Qt=s=>{const t=Ut(void 0),e=L(a=>t.current=a,[]),i=s.shadowRoot,r=L(a=>s.dispatchEvent(new Event(a.type,{bubbles:a.bubbles})),[]),n=L(a=>et(s,"value",a.target.value),[]),o=L(a=>et(s,"focused",a.type==="focus"),[]),h=L(()=>{var a;return(a=t.current)==null?void 0:a.focus()},[]),l=L(()=>{var v;const a=(v=t.current)==null?void 0:v.checkValidity();return s.toggleAttribute("invalid",!a),a},[]);return Yt({focus:h,validate:l},[h,l]),x(()=>{const a=v=>{v.defaultPrevented||s.disabled||v.target.matches("input, textarea, label")||(v.preventDefault(),s.matches(":focus-within")||h())};return i.addEventListener("mousedown",a),()=>i.removeEventListener("mousedown",a)},[h]),{onChange:r,onFocus:o,onInput:n,onRef:e}},Ue=s=>M(()=>{if(s==null)return;const t=new RegExp(s,"u");return e=>{!e.defaultPrevented&&e.data&&!t.test(e.data)&&e.preventDefault()}},[s]),Jt=(s,{label:t,invalid:e,errorMessage:i})=>S`
	...
	`,Kt=["autocomplete","readonly","disabled","maxlength","invalid","no-label-float","always-float-label"],We=({placeholder:s,noLabelFloat:t,label:e})=>(t?e:void 0)||s||" ",Ge=(s,...t)=>s.flatMap((e,i)=>[e,t[i]??""]).join(""),Zt=Ge`
	:host {
		--font-family: var(
...
`,qe=["type","pattern","allowed-pattern","min","max","step","autosize","label",...Kt],Ye=s=>{var p;const{type:t="text",pattern:e,allowedPattern:i,autocomplete:r,value:n,readonly:o,disabled:h,min:l,max:a,step:v,maxlength:d}=s,{onChange:f,onFocus:_,onInput:b,onRef:g}=Qt(s),m=Ue(i);return Yt({focus:()=>{var y,w;return(w=(y=s.shadowRoot)==null?void 0:y.querySelector("#input"))==null?void 0:w.focus()}},[]),Jt(S`
			<input
				${gt(g)}
				...
				step=${P(v)}
			/>
		`,s)};customElements.define("cosmoz-input",vt(Ye,{observedAttributes:qe,styleSheets:[mt(Zt)]}));const Tt=s=>{s.style.height="",s.style.height=`${s.scrollHeight}px`},Qe=(s,t=0)=>{if(t>0){const e=s.getAttribute("rows")??"",i=s.style.height;s.style.height="",s.setAttribute("rows",t),s.style.maxHeight=s.getBoundingClientRect().height+"px",s.style.height=i,s.setAttribute("rows",e)}},Je=s=>{const{value:t,maxRows:e}=s,i=M(()=>()=>s.shadowRoot.querySelector("#input"),[]);x(()=>Qe(i(),e),[e,i]),x(()=>Tt(i()),[i,t]),x(()=>{const r=i(),n=new ResizeObserver(()=>requestAnimationFrame(()=>Tt(r)));return n.observe(r),()=>n.unobserve(r)},[i])},Ke=["rows",...Kt],Ze=s=>{const{autocomplete:t,value:e,placeholder:i,readonly:r,disabled:n,rows:o,cols:h,maxlength:l}=s,{onChange:a,onFocus:v,onInput:d,onRef:f}=Qt(s);return Je(s),Jt(S`
...
`,ns=({tree:s,searchPlaceholder:t,searchGlobalPlaceholder:e,searchMinLength:i=3,opened:r,searchDebounceTimeout:n=2e3})=>{const o=Ut(),h=He(),[l,a]=Q("highlightedNode"),[v,d]=Q("nodesOnNodePath",[]),[f,_]=dt(""),[b,g]=dt(""),[m,p]=dt(""),[y,w]=Q("selectedNode"),[I,ot]=Q("nodePath","");x(()=>{const c=setTimeout(()=>{const C=b.trim().length;C>0&&C<i||_(b.trim())},n);return()=>clearTimeout(c)},[b]);const lt=M(()=>es(s,f,m),[s,f,m]),bt=L(c=>{if(!(c!=null&&c.pathLocator)||!s){d([]);return}const C=Rt(c.pathLocator,s);d(C)},[s]),G=L(c=>{p((c==null?void 0:c.pathLocator)||""),g(""),a(null)},[]),at=L(c=>{c&&(a(c),w(c),ot(c.pathLocator??""),bt(c))},[bt]);x(()=>{m&&(et(h,"highlightedNodePath",""),ot(""))},[m]),x(()=>{if(!(v!=null&&v.length)||!s||!r)return;const c=v[v.length-1];if(!(c!=null&&c.pathLocator))return;if(s.hasChildren(c)){p(c.pathLocator);return}const C=ft(s,c);p(C),a(c)},[v,s,r]),x(()=>{et(h,"highlightedNodePath",(l==null?void 0:l.pathLocator)||""),(l==null?void 0:l.pathLocator)!==I&&ot((l==null?void 0:l.pathLocator)??""),l!==y&&w(l)},[l]),x(()=>{y!==l&&a(y)},[y]),x(()=>{if(!(I||s))return;const c=Rt(I,s);d(c);const C=c.length>0?c[c.length-1]:null;C&&C!==l&&a(C)},[I,s]);const V=Xe({dataPlane:lt,highlightedNode:l??null,onNodeClick:G});x(()=>{var yt;if(!r)return;const c=()=>{const E=o.current;return E?E[Object.getOwnPropertySymbols(E)[0]]:null},C=c();if(C&&V.highlightedNode){const E=(yt=V.dataPlane)==null?void 0:yt.indexOf(V.highlightedNode);E!==void 0&&E>=0&&(C.scrollToIndex={index:E,position:"center"})}const B=E=>{if(E.ctrlKey&&E.altKey||E.defaultPrevented)return;const{dataPlane:q,highlightedNode:$,onNodeClick:ee}=V,Y=c();if(!Y)return;const ht=q.findIndex(k=>k.pathLocator===($==null?void 0:$.pathLocator)),wt=(k,Ct)=>k>=0&&k<q.length?(a(q[k]),(Ct==="start"?k<Y._firstVisible:k>Y._lastVisible)&&(Y.scrollToIndex={index:k,position:Ct}),!0):!1;switch(E.key){case"Up":case"ArrowUp":{E.preventDefault(),wt(Math.max(ht-1,0),"start");break}case"Down":case"ArrowDown":{E.preventDefault(),ht<q.length-1&&wt(ht+1,"end");break}case"Enter":E.preventDefault(),$&&(h.dispatchEvent(new CustomEvent("node-dblclicked")),at($));break;case"Right":case"ArrowRight":E.preventDefault(),$&&s.hasChildren($)&&ee($);break}};return document.addEventListener("keydown",B,!0),()=>document.removeEventListener("keydown",B,!0)},[r,V,at]);const Xt=c=>{is(c,h),l&&at(l)},te=(c,C)=>c?S` <div class="item">
