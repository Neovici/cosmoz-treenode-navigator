import{T as u,a as l}from"./tree-data-COwffZGJ.js";import{j as s,b as i}from"./iframe-B8nujFHe.js";import"./cosmoz-treenode-navigator-C_QL79Zk.js";import"./preload-helper-PPVm8Dsz.js";const{expect:c,waitFor:p}=__STORYBOOK_MODULE_TEST__,h=new u(l),w={title:"Components/CosmozTreenodeNavigator",component:"cosmoz-treenode-navigator",tags:["autodocs"],argTypes:{searchMinLength:{control:"number"},searchDebounceTimeout:{control:"number"},opened:{control:"boolean"},nodePath:{control:"text"}},args:{searchMinLength:3,searchDebounceTimeout:500,opened:!0,nodePath:""}},a={render:e=>i`
        <div
    ...
    `,play:async({canvasElement:e,step:n})=>{const t=e.querySelector("cosmoz-treenode-navigator");await n("Sets search placeholder via i18next",async()=>{await p(async()=>{const r=(await s(t,"search-input")).shadowRoot?.querySelector("input");c(r?.placeholder).toBe("Search...")})})}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  render: args => html\`
        <div
            style="height: 400px; width: 500px; border: 1px solid #ccc; padding: 10px;"
        >
...
}`,...o.parameters?.docs?.source}}};const T=["Default","WithCustomSearchMinLength"];export{a as Default,o as WithCustomSearchMinLength,T as __namedExportsOrder,w as default};
