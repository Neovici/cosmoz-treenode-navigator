 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const F=(s,t)=>{const e=s._$AN;if(e===void 0)return!1;for(const i of e)i._$AO?.(t,!1),F(i,t);return!0},Z=s=>{let t,e;do{if((t=s._$AM)===void 0)break;e=t._$AN,e.delete(s),s=t}while(e?.size===0)},Vt=s=>{for(let t;t=s._$AM;s=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(s))break;e.add(s),be(t)}};function ge(s){this._$AN!==void 0?(Z(this),this._$AM=s,Vt(this)):this._$AM=s}function ve(s,t=!1,e=0){const i=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(t)if(Array.isArray(i))for(let n=e;n<i.length;n++)F(i[n],!1),Z(i[n]);else i!=null&&(F(i,!1),Z(i));else F(this,s)}const be=s=>{s.type==z.CHILD&&(s._$AP??=ve,s._$AQ??=ge)};class Bt extends X{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,i){super._$AT(t,e,i),Vt(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(F(this,t),Z(this))}setValue(t){if(Tt(this._$Ct))this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}const{component:_t}=me({render:Jt}),ct=new WeakMap,mt=j(class extends Bt{render(s){return H}update(s,[t]){const e=t!==this.G;return e&&this.G!==void 0&&this.rt(void 0),(e||this.lt!==this.ct)&&(this.G=t,this.ht=s.options?.host,this.rt(this.ct=s.element)),H}rt(s){if(this.isConnected||(s=void 0),typeof this.G=="function"){const t=this.ht??globalThis;let e=ct.get(t);e===void 0&&(e=new WeakMap,ct.set(t,e)),e.get(this.G)!==void 0&&this.G.call(this.ht,void 0),e.set(this.G,s),s!==void 0&&this.G.call(this.ht,s)}else this.G.value=s}get lt(){return typeof this.G=="function"?ct.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const zt=(s,t,e)=>{const i=new Map;for(let r=t;r<=e;r++)i.set(s[r],r);return i},Ce=j(class extends X{constructor(s){if(super(s),s.type!==z.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,t,e){let i;e===void 0?e=t:t!==void 0&&(i=t);const r=[],n=[];let o=0;for(const l of s)r[o]=i?i(l,o):o,n[o]=e(l,o),o++;return{values:n,keys:r}}render(s,t,e){return this.dt(s,t,e).values}update(s,[t,e,i]){const r=Kt(s),{values:n,keys:o}=this.dt(t,e,i);if(!Array.isArray(r))return this.ut=o,n;const l=this.ut??=[],h=[];let a,v,u=0,p=r.length-1,f=0,g=n.length-1;for(;u<=p&&f<=g;)if(r[u]===null)u++;else if(r[p]===null)p--;else if(l[u]===o[f])h[f]=T(r[u],n[f]),u++,f++;else if(l[p]===o[g])h[g]=T(r[p],n[g]),p--,g--;else if(l[u]===o[g])h[g]=T(r[u],n[g]),V(s,h[g+1],r[u]),u++,g--;else if(l[p]===o[f])h[f]=T(r[p],n[f]),V(s,r[u],r[p]),p--,f++;else if(a===void 0&&(a=zt(o,f,g),v=zt(l,u,p)),a.has(l[u]))if(a.has(l[p])){const _=v.get(o[f]),d=_!==void 0?r[_]:null;if(d===null){const m=V(s,r[u]);T(m,n[f]),h[f]=m}else h[f]=T(d,n[f]),V(s,r[u],d),r[_]=null;f++}else lt(r[p]),p--;else lt(r[u]),u++;for(;f<=g;){const _=V(s,h[g+1]);T(_,n[f]),h[f++]=_}for(;u<=p;){const _=r[u++];_!==null&&lt(_)}return this.ut=o,Nt(s,h),$}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ft=j(class extends X{constructor(s){if(super(s),s.type!==z.PROPERTY&&s.type!==z.ATTRIBUTE&&s.type!==z.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Tt(s))throw Error("`live` bindings can only contain a single expression")}render(s){return s}update(s,[t]){if(t===$||t===H)return t;const e=s.element,i=s.name;if(s.type===z.PROPERTY){if(t===e[i])return $}else if(s.type===z.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(i))return $}else if(s.type===z.ATTRIBUTE&&e.getAttribute(i)===t+"")return $;return Nt(s),t}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const L=s=>s??H,Ht=A(class extends k{values;constructor(s,t,e,i){super(s,t),Object.assign(t.host,e),this.values=i}update(s,t){this.hasChanged(t)&&(this.values=t,Object.assign(this.state.host,s))}hasChanged(s=[]){return s.some((t,e)=>this.values[e]!==t)}}),Re=A(class extends k{update(){return this.state.host}}),Oe=/([A-Z])/gu,pt=(s,t,e)=>{s[t]=e,s.dispatchEvent(new CustomEvent(t.replace(Oe,"-$1").toLowerCase()+"-changed",{detail:{value:e}}))},jt=s=>{const t=Dt(void 0),e=x(a=>t.current=a,[]),i=s.shadowRoot,r=x(a=>s.dispatchEvent(new Event(a.type,{bubbles:a.bubbles})),[]),n=x(a=>pt(s,"value",a.target.value),[]),o=x(a=>pt(s,"focused",a.type==="focus"),[]),l=x(()=>t.current?.focus(),[]),h=x(()=>{const a=t.current?.checkValidity();return s.toggleAttribute("invalid",!a),a},[]);return Ht({focus:l,validate:h},[l,h]),S(()=>{const a=v=>{v.defaultPrevented||s.disabled||v.target.matches("input, textarea, label")||(v.preventDefault(),s.matches(":focus-within")||l())};return i.addEventListener("mousedown",a),()=>i.removeEventListener("mousedown",a)},[l]),{onChange:r,onFocus:o,onInput:n,onRef:e}},Me=s=>R(()=>{if(s==null)return;const t=new RegExp(s,"u");return e=>{!e.defaultPrevented&&e.data&&!t.test(e.data)&&e.preventDefault()}},[s]),Ut=(s,{label:t,invalid:e,errorMessage:i})=>E`
...
`,Ve=["type","pattern","allowed-pattern","min","max","step","autosize","label",...Wt],Be=s=>{const{type:t="text",pattern:e,allowedPattern:i,autocomplete:r,value:n,readonly:o,disabled:l,min:h,max:a,step:v,maxlength:u}=s,{onChange:p,onFocus:f,onInput:g,onRef:_}=jt(s),d=Me(i);return Ht({focus:()=>s.shadowRoot?.querySelector("#input")?.focus()},[]),Ut(E`
			<input
				${mt(_)}
...
`,Ke=({tree:s,searchPlaceholder:t,searchGlobalPlaceholder:e,searchMinLength:i=3,opened:r,searchDebounceTimeout:n=2e3})=>{const o=Dt(),l=Re(),[h,a]=q("highlightedNode"),[v,u]=q("nodesOnNodePath",[]),[p,f]=ht(""),[g,_]=ht(""),[d,m]=ht(""),[b,C]=q("selectedNode"),[it,gt]=q("nodePath","");S(()=>{const c=setTimeout(()=>{const y=g.trim().length;y>0&&y<i||f(g.trim())},n);return()=>clearTimeout(c)},[g]);const rt=R(()=>qe(s,p,d),[s,p,d]),vt=x(c=>{if(!c?.pathLocator||!s){u([]);return}const y=At(c.pathLocator,s);u(y)},[s]),U=x(c=>{m(c?.pathLocator||""),_(""),a(null),gt(""),u([])},[]),nt=x(c=>{c&&(a(c),C(c),gt(c.pathLocator??""),vt(c))},[vt]);S(()=>{if(!v?.length||!s||!r)return;const c=v[v.length-1];if(!c?.pathLocator)return;if(s.hasChildren(c)){m(c.pathLocator);return}const y=ut(s,c);m(y),a(c)},[v,s,r]),S(()=>{pt(l,"highlightedNodePath",h?.pathLocator||"")},[h]),S(()=>{b&&b!==h&&a(b)},[b]),S(()=>{if(!(it||s))return;const c=At(it,s);u(c);const y=c.length>0?c[c.length-1]:null;y&&y!==h&&a(y)},[it,s]);const I=We({dataPlane:rt,highlightedNode:h??null,onNodeClick:U});S(()=>{if(!r)return;const c=()=>{const w=o.current;return w?w[Object.getOwnPropertySymbols(w)[0]]:null},y=c();if(y&&I.highlightedNode){const w=I.dataPlane?.indexOf(I.highlightedNode);w!==void 0&&w>=0&&(y.scrollToIndex={index:w,position:"center"})}const D=w=>{if(w.ctrlKey&&w.altKey||w.defaultPrevented)return;const{dataPlane:W,highlightedNode:O,onNodeClick:Qt}=I,G=c();if(!G)return;const ot=W.findIndex(P=>P.pathLocator===O?.pathLocator),bt=(P,yt)=>P>=0&&P<W.length?(a(W[P]),(yt==="start"?P<G._firstVisible:P>G._lastVisible)&&(G.scrollToIndex={index:P,position:yt}),!0):!1;switch(w.key){case"Up":case"ArrowUp":{w.preventDefault(),bt(Math.max(ot-1,0),"start");break}case"Down":case"ArrowDown":{w.preventDefault(),ot<W.length-1&&bt(ot+1,"end");break}case"Enter":w.preventDefault(),O&&(l.dispatchEvent(new CustomEvent("node-dblclicked")),nt(O));break;case"Right":case"ArrowRight":w.preventDefault(),O&&s.hasChildren(O)&&Qt(O);break}};return document.addEventListener("keydown",D,!0),()=>document.removeEventListener("keydown",D,!0)},[r,I,nt]);const qt=c=>{Qe(c,l),h&&nt(h)},Yt=(c,y)=>c?E` <div class="item">
			${(D=>M(p&&(y===0||D!==ut(s,rt[y-1])),()=>E`
						<div class="section">
