import{x as l}from"./iframe-rL8wds2w.js";import{T as c,a as s}from"./tree-data-D6JT0cnr.js";import"./cosmoz-treenode-button-view-3BtkdgHX.js";import"./preload-helper-PPVm8Dsz.js";const g={title:"Components/CosmozTreenodeButtonView",component:"cosmoz-treenode-button-view",tags:["autodocs"],argTypes:{buttonTextPlaceholder:{control:"text"},dialogText:{control:"text"},searchPlaceholder:{control:"text"},searchGlobalPlaceholder:{control:"text"},searchMinLength:{control:"number"},searchDebounceTimeout:{control:"number"},noReset:{control:"boolean"},multiSelection:{control:"boolean"}}},a=e=>{const n=new c(s);return l`
