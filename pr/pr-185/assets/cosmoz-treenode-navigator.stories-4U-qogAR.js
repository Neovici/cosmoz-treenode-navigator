import{T as S,a as B}from"./tree-data-DkP9SggD.js";import{j as d,b as p,N as l,D as P}from"./iframe-HdTjGH4e.js";import"./preload-helper-PPVm8Dsz.js";const{expect:a,userEvent:T,waitFor:c}=__STORYBOOK_MODULE_TEST__,m=new S(B),E={title:"Components/CosmozTreenodeNavigator",component:"cosmoz-treenode-navigator",tags:["autodocs"],argTypes:{searchPlaceholder:{control:"text"},searchGlobalPlaceholder:{control:"text"},searchMinLength:{control:"number"},searchDebounceTimeout:{control:"number"},opened:{control:"boolean"}},args:{searchPlaceholder:"Search...",searchGlobalPlaceholder:"Click to search again but globally",searchMinLength:3,searchDebounceTimeout:2e3,opened:!0}},g={render:e=>p`
        <div
