import{T as S,o as p,a as D}from"./tree-data-DkP9SggD.js";import{j as l,b,N as r,D as k}from"./iframe-HdTjGH4e.js";import"./cosmoz-treenode-button-view-DiMiFPkL.js";import"./preload-helper-PPVm8Dsz.js";const{expect:n,waitFor:c}=__STORYBOOK_MODULE_TEST__,y=new S(D),E={title:"Components/CosmozTreenodeButtonView",component:"cosmoz-treenode-button-view",tags:["autodocs"],argTypes:{buttonTextPlaceholder:{control:"text"},dialogText:{control:"text"},searchPlaceholder:{control:"text"},searchGlobalPlaceholder:{control:"text"},searchMinLength:{control:"number"},searchDebounceTimeout:{control:"number"},noReset:{control:"boolean"},nodePath:{control:"text"}},args:{buttonTextPlaceholder:"Select a node",dialogText:"Search or navigate to chosen destination",searchPlaceholder:"Search...",searchGlobalPlaceholder:"Click to search again but globally",searchMinLength:3,searchDebounceTimeout:2e3,noReset:!1,nodePath:""}},B={render:e=>b`
