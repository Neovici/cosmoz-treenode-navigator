import{x as c}from"./iframe-DO9_uU87.js";import{T as s,a as d}from"./tree-data-CIfhIz_T.js";import"./preload-helper-D9Z9MdNV.js";const g={title:"Components/CosmozTreenodeNavigator/Legacy",component:"cosmoz-treenode-navigator",tags:["autodocs"],argTypes:{searchPlaceholder:{control:"text"},searchGlobalPlaceholder:{control:"text"},searchMinLength:{control:"number"},searchDebounceTimeout:{control:"number"},opened:{control:"boolean"},nodePath:{control:"text"}}},t=e=>{const a=new s(d),n=e.nodePath?a.getNodeByPathLocator(e.nodePath):void 0;return c`
        <div
